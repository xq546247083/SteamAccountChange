...
- 点击工具栏的 **"刷新"** 按钮,程序会自动读取 Steam 本地文件,识别所有登录过的账号
- 账号信息包括:账号名、昵称、头像
- **主窗口切换**: 选中账号卡片,点击"打开"或双击卡片
- **托盘菜单切换**: 右键点击系统托盘图标,选择要切换的账号
- **登录新账号**: 托盘菜单中选择"登录新账号",会打开 Steam 登录界面
- **拖拽排序**: 拖动账号卡片可调整显示顺序
